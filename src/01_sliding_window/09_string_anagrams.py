...
Every anagram is a permutation of a string. As we know, when we are not allowed to repeat
  ...
  of a string having N characters. For example, here are the six anagrams of the string "abc":
...
Space complexity:
  ...
  In the worst case, we also need O(N) space for the result list. This will happen when the pattern has only

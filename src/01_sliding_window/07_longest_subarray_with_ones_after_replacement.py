"""
Problem statement
Given an array containing 1's and 0's, if you are allowed to replace no more than 'k'
  0's with 1's, find the length of the longest contiguous subarray having all 1's.
